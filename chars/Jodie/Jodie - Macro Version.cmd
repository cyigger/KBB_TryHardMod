...
Triggerall = power < 3000
value = 500
triggerall = command = "s" && ((command != "holdfwd" && command != "holdback") || command = "holddown")
Triggerall = statetype != A
trigger1 = ctrl
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; BASE JODIE - Down + C - No Sword Pickup
[State -1, C]
type = ChangeState
value = 960
triggerall = numhelper(3500) = 0
...
trigger1 = stateno = 0
;---------------------------------------------------------------------------
; BASE JODIE - Down + C - Sword Pickup
[State -1, C]
type = ChangeState
value = 960
triggerall = numhelper(3500) = 0
triggerall = numhelper(23420) = 0
triggerall = numhelper(2860) = 1
triggerall = var(10) = 0
triggerall = command = "holddown"
triggerall = command = "c"
Triggerall = statetype != A
trigger1 = ctrl
trigger1 = (helper(2860), stateno != 2870 && helper(2860), stateno != 23020) && (helper(2860), rootdist  x <= 50 && helper(2860), rootdist x >= 0 || helper(2860), rootdist x >= -50 && helper(2860), rootdist x <= 0)
;---------------------------------------------------------------------------
; SWORD JODIE - Down + C
[State -1, C]
type = ChangeState
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; SWORD JODIE - Down + C - ROUND START
[State -1, C]
type = ChangeState
value = 967
triggerall = var(10) = 1
...
value = 66
triggerall = var(4) = 0 
triggerall = command = "s" && (command != "holdfwd" && command != "holdback")
Triggerall = statetype = A
