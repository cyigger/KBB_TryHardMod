...
type = ChangeState
value = 21000
triggerall = numhelper(3500) = 0 ; If not glithced (The Glitched helper does not exist)
triggerall = command = "SPECIAL 1" ; The player inputs the command for "Special 1" (Down, down+ forward, forward, A)
Triggerall = statetype != A ; The character is NOT in the air
Triggerall = power >= 1000 ; The character has at least 1000 power
triggerall = numhelper(21500) = 0; Can't use while another 236a is already out
triggerall = numhelper(21501) = 0; Can't use while another 236a is already out
trigger1 = ctrl ; The player has control over their character (They aren't commited to another attack)
;---------------------------------------------------------------------------
; Special 2
[State -1, SPECIAL 2]
type = ChangeState
