...
[Command]
name = "DDc"     ;Required (do not remove)
command = ~D, D, c
time = 15
;buffer.time = 20

[Command]
name = "FFc"     ;Required (do not remove)
command = ~F, F, c
time = 15
;buffer.time = 1
...
;---------------------------------------------------------------------------
; Down Forward B
[State -1, Dash Attack (5BB But Seperate)]
type = ChangeState
value = 330
triggerall = command = "holddown"
triggerall = command = "holdfwd"
...
;---------------------------------------------------------------------------
; Forward + C
[State -1, Down Forward + C]
type = ChangeState
value = 430
triggerall = numhelper(9870) = 0 ;Destroyed
triggerall = map(shatterCount) < 4 ;Shatter Count
Triggerall = power >= 250
triggerall = numhelper(3500) = 0
triggerall = numhelper(405) = 0
triggerall = numhelper(24500) = 0
