...
Triggerall= random<var(50)*1.1 + abs(P2Bodydist X) + (16- var(47)) * 20
trigger1 = ctrl
value = 450
...
Triggerall= (abs(P2Bodydist X) < 40 && enemy,movetype = H) || (abs(P2Bodydist X) > 40 && abs(P2Bodydist X) < 100)
Triggerall= Statetype = S 
...
Type = Changestate
triggerall = numhelper(3500) = 0
Triggerall = stateno = 400 && movehit = 1
Triggerall = var(47) > 0
Triggerall = var(59)>0 
Triggerall = power >= 300
Triggerall = var(47) > 0
...
Type = Changestate
triggerall = numhelper(3500) = 0
Triggerall = stateno = 410 && movehit = 1
Triggerall = var(47) > 0
Triggerall = var(59)>0 
Triggerall = power >= 300
Triggerall = var(47) > 0
...
Triggerall= Statetype = S 
Triggerall=random < (ailevel ** ailevel) + 500
Trigger1 = stateno = 410 && movehit = 1
value = 420
...
Triggerall=var(59)>0 
Triggerall = var(47) > 0
Triggerall = Stateno = 605  && movehit = 1
Triggerall= Statetype = A 
Triggerall=abs(P2Bodydist X)<40 
Triggerall=P2StateType=A
Triggerall=random < (ailevel ** ailevel) + 500
...
[state -1, Down C-Air AI]
Type = Changestate
Triggerall=var(59)>0 
Triggerall = var(47) > 0
Triggerall = power >= 100
Triggerall = Stateno = 625  && movehit = 1
Triggerall= Statetype = A 
Triggerall=abs(P2Bodydist X)<40 
Triggerall=P2StateType=A
Triggerall=!Inguarddist
Triggerall=random<var(50)*1.1
Trigger1 = Stateno = 625  && movehit = 1
value = 635
