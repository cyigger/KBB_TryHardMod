...
triggerall = stateno != 23000 && stateno != 472
triggerall = command = "down"
triggerall = vel y > -1 && vel y < 8
trigger1 = 1
y = 8
...
;===========================================================================
;---------------------------------------------------------------------------
; Special 7 - The Plasma Princess.
[State -1, SPECIAL 7 - The Plasma Princess.]
type = ChangeState
value = 27000
...
;---------------------------------------------------------------------------
; Fwd + C - AIR
; This performs the faster state.
[State -1, C]
type = ChangeState
value = 613
triggerall = numhelper(3500) = 0
