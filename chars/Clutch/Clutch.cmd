...
Triggerall=P2StateType=A;
Triggerall=random<var(50)*1.1
Trigger1 = Stateno = 607  && movehit = 1
value = 615
...
Triggerall=P2StateType=A;
Triggerall=random<var(50)*1.1
Trigger1 = Stateno = 615  && movehit = 1
value = 617
...
triggerall = power > 500
triggerall = numhelper(3500) = 0
triggerall = stateno != 620 && prevstateno != 620
Triggerall= Statetype = A
Triggerall=abs(P2Bodydist X)>100 && (P2Bodydist Y) > 50
