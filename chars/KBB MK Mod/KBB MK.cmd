...
Trigger1 = random< (var(50)*2+(AiLevel>=3)*10); chance is higher than for attacking, but not by too much.
value=120
...
type = ChangeState
value = 970
triggerall = anim = 100 || command = "FF"
