...
triggerall = stateno != 350 ;Moves that have been nerfed to not allow fastfall during them
...
;---------------------------------------------------------------------------
; Special 1
[State -1, SPECIAL 1 - Triple Slash]
type = ChangeState
value = 21000
...
;---------------------------------------------------------------------------
; Special 2
[State -1, SPECIAL 2 - Rapidslash DP]
type = ChangeState
value = 22000
triggerall = numhelper(3500) = 0
...
;---------------------------------------------------------------------------
; Special 3
[State -1, SPECIAL 3 - Spinner Cutters]
type = ChangeState
value = 23000
triggerall = numhelper(3500) = 0
...
;---------------------------------------------------------------------------
; Special 4
[State -1, SPECIAL 4 - Sleeper Move]
type = ChangeState
value = 24000
triggerall = numhelper(3500) = 0
...
triggerall = numhelper(50100) = 0 ;Buffer cooldown
...
type = ChangeState
value = 403
triggerall = numhelper(406) >= 1 || numhelper(401) >= 1
triggerall = numhelper(3500) = 0
Triggerall = power >= 200
triggerall = command = "c"
Triggerall = statetype = A
...
Triggerall=var(59)>0 
Triggerall= Statetype = S 
Triggerall=(abs(P2Bodydist X)>40 && abs(P2Bodydist X) < 200) || helper,stateno = 402 && helper,movecontact
Triggerall=P2StateType=S
Triggerall=random<var(50)*1.1
trigger1 = ctrl
value = 300
...
triggerall = numhelper(3500) = 0
triggerall = P2BodyDist Y > 50 && enemy,vel Y < 0
...
Triggerall=var(59)>0 
Triggerall= Statetype = S 
Triggerall=abs(P2Bodydist X)>40 && abs(P2Bodydist X) < 100
Triggerall=abs(P2Bodydist Y)>40 && abs(P2Bodydist Y) < 100 
...
Triggerall=var(59)>0 
triggerall =statetype = S
Triggerall=abs(P2Bodydist X) > 40 &&  abs(P2Bodydist X) < 80
Triggerall=P2StateType=A
Triggerall=random<var(50)*1.1
Trigger1 = ctrl
value = 610
...
Triggerall=var(59)>0 
Triggerall=Statetype = A 
Triggerall=abs(P2Bodydist X) < 200 && abs (P2BodyDist Y) < 200
Triggerall=abs(P2Bodydist X) > 100 && abs (P2BodyDist Y) > 100
Triggerall=P2StateType=A
Triggerall=!Inguarddist
Triggerall=random<var(50)*1.1
Trigger1 = ctrl
